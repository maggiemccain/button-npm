...
import * as import1 from './amazing.module';
...
import * as import10 from './amazing.component.ngfactory';
import * as import11 from '@angular/core/src/i18n/tokens';
import * as import12 from '@angular/http/src/interfaces';
import * as import13 from '@angular/http/src/http';
class AmazingModuleInjector extends import0.NgModuleInjector<import1.AmazingModule> {
  _CommonModule_0:import2.CommonModule;
  _HttpModule_1:import3.HttpModule;
  _AmazingModule_2:import1.AmazingModule;
  ...
  constructor(parent:import9.Injector) {
    super(parent,[import10.AmazingComponentNgFactory],[import10.AmazingComponentNgFactory]);
  }
  get _NgLocalization_3():import4.NgLocaleLocalization {
    if ((this.__NgLocalization_3 == null)) { (this.__NgLocalization_3 = new import4.NgLocaleLocalization(this.parent.get(import11.LOCALE_ID))); }
  ...
  createInternal():import1.AmazingModule {
    this._CommonModule_0 = new import2.CommonModule();
    this._HttpModule_1 = new import3.HttpModule();
    this._AmazingModule_2 = new import1.AmazingModule();
    return this._AmazingModule_2;
  }
  getInternal(token:any,notFoundResult:any):any {
    if ((token === import2.CommonModule)) { return this._CommonModule_0; }
    if ((token === import3.HttpModule)) { return this._HttpModule_1; }
    if ((token === import1.AmazingModule)) { return this._AmazingModule_2; }
    ...
    if ((token === import12.XSRFStrategy)) { return this._XSRFStrategy_6; }
    if ((token === import7.XHRBackend)) { return this._XHRBackend_7; }
    if ((token === import8.RequestOptions)) { return this._RequestOptions_8; }
    if ((token === import13.Http)) { return this._Http_9; }
    return notFoundResult;
  }
  destroyInternal():void {
  }
}
export const AmazingModuleNgFactory:import0.NgModuleFactory<import1.AmazingModule> = new import0.NgModuleFactory(AmazingModuleInjector,import1.AmazingModule);